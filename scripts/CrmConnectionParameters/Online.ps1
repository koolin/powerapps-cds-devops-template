...
@{
    OrganizationName = "org7c152af4" # see Settings > Customizations > Developer Resources > "Unique Name"
    ServerUrl = "https://orgac8ed0fa.crm3.dynamics.com" # the online organization URL
