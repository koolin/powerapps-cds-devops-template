...
@{
    OrganizationName = "orgec3715bb" # see Settings > Customizations > Developer Resources > "Unique Name"
    ServerUrl = "https://org92c44143.crm3.dynamics.com" # the online organization URL
