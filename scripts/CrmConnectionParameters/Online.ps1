...
@{
    OrganizationName = "org941409ae" # see Settings > Customizations > Developer Resources > "Unique Name"
    ServerUrl = "https://org0a601ea4.crm3.dynamics.com" # the online organization URL
